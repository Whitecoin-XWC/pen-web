<template>
  <div class="dialog-container">
    <el-dialog :close-on-click-modal="false" :title="$t('确认')" :visible.sync="isShowPublishDialog" :before-close="handleClose">
...
export default {
  ...
  computed: {
    ...mapState('publish', ['isShowPublishDialog', 'copyrightFee', 'publishName', 'tokenId']),
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      if (res1.code === 200 && res1.data) {
        ...
        this.$message.error(this.$t('上传出现异常'))
      }
    },
  },
}
